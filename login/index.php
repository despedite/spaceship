...
<style>
  ...
  top:50%;
  left:50%;
  margin-top:-147px; /* this is half the height of your div*/  
...
<div class="card text-white bg-dark font-old" style="width: 18rem;" id="cent">
  <div class="card-body">
    <h5 class="card-title">Iniciá sesión</h5>
	...
	<form method="post" action="index.php">
	  ...
	  <button type="submit" class="btn btn-primary" name="login_user">¡Listo!</button>
	</form>
    <a href="../register" class="card-link"><button type="button" class="btn btn-outline-secondary">Registrate</button></a>
  </div>
</div>
